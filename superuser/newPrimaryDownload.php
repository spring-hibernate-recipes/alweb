	...
	<div class="main-content">
		...
		<form method="post" action="savePrimaryDownload.php" class="form">
			<div class="form-group">
				<?php select($releases, NULL, "releaseId")?>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<input type="text" name="downloadLink" placeholder="Download Link"
					class="form-control" id="downloadLink">
			</div>
			<div class="form-group">
				<textarea name="releaseNotes" placeholder="Release Notes"
					class="form-control" id="releaseNotes" style="height: 200px;"></textarea>
			</div>
			<div class="form-group">
				<?php select(array("orange"=>"Orange Button", "blue"=>"Blue Button"), "orange", "downloadButtonClass")?>
			</div>
			<div class="form-group">
